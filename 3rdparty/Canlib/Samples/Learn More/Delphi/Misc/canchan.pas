...
function  TCanChannel.WriteSync(timeout : Cardinal) : integer;
begin
...
function  TCanChannel.ReadSync(timeout : Cardinal):integer;
begin
   Result := canReadSync(FCanHnd, timeout);
end;

function  TCanChannel.ReadSyncSpecific(id, timeout : Cardinal):integer;
begin
...
function  TCanChannel.ReadTimer:Cardinal;
begin
{$IFDEF WIN32}
...
function TCanChannel.ReadStatus: Cardinal;
var stat : canStatus;
begin
