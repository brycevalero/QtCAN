...
{
  int flags = 0;
  unsigned char data[8] = {(unsigned char)ui->spinBoxData0->value(),
                           (unsigned char)ui->spinBoxData1->value(),
                           (unsigned char)ui->spinBoxData2->value(),
                           (unsigned char)ui->spinBoxData3->value(),
                           (unsigned char)ui->spinBoxData4->value(),
                           (unsigned char)ui->spinBoxData5->value(),
                           (unsigned char)ui->spinBoxData6->value(),
                           (unsigned char)ui->spinBoxData7->value()};
