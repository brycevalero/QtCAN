/*
**                         Copyright 1996-2016 by KVASER AB
...
//
void PumpMessages(canHandle srcHandle, canHandle dstHandle, int nrMsgs)
{
  int i, j, k, m;
  canStatus stat;
  long id;
...
//
void FillCircuit(canHandle srcHandle, int nrMsgs, int startId)
{
  int i;
  canStatus stat;
  long srcID = startId;
