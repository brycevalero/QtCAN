...
#define KVADB_MESSAGE_J1939    0x00000001  ///< Message uses J1939 protocol. This flag is currently not used.
...
/**
 * \ingroup kvadb_database
 * This function gets an existing database's name.
 *
 * \param[in] dh         A database handle
...
/**
 * \ingroup kvadb_signals
 * Get the string and integer from the first enumeration value for a signal.
 *
 * \param[in]  sh      A signal handle.
...
/**
 * \ingroup kvadb_signals
 * Get the string and integer from the next enumeration value for a signal.
