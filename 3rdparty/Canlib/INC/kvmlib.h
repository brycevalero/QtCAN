 ...
 *
 * \source_cs       <b>static void Initialize(void);</b>
 * \source_end
 *
 ...
 *\ingroup kvm_connection
 *
 * \source_cs       <b>static Kvmlib.Handle DeviceOpen(Int32 memoNr, out Status status, DeviceType deviceType);</b>
 * \source_end
 *
 ...
 *
 * \source_cs       <b>static Kvmlib.Status LogFileGetCount(Handle^ h, out Int32 fileCount);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileMount(Handle^ h, Int32 fileIndx, out Int32 eventCount);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static void LogFileDismount(Handle^ h);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileGetStartTime(Handle^ h, out Int32 startTime);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileGetEndTime(Handle^ h, out Int32 endTime);</b>
 * \source_end
 *
 * Get the time of the first event in the log file. The time is returned in
 * standard unix time format (number of seconds since 1970-01-01T00:00:00+00:00).
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileGetCreatorSerial(Handle^ h, out Int32 serialNumber);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileReadEvent(Handle^ h, out Log^ e);</b>
 * \source_end
 *
 * Read an event from a log file opened with kvmLogFileMount(). The next call to
 ...
 * \ingroup kvm_data_extraction
 *
 * \source_cs       <b>static Kvmlib.Status LogFileDeleteAll(Handle^ h);</b>
 * \source_end
 *
 ...
 *
 * \source_cs       <b>static Kvmlib.Status KmfReadConfig(Handle^ h, out array<Byte>^ buf);</b>
 * \source_end
 *
 ...
 * \ingroup kvm_configuration
 *
 * \source_cs       <b>static Kvmlib.Status KmfWriteConfig(Handle^ h, array<Byte>^ buf);</b>
 * \source_end
 *
